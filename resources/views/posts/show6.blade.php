...
<html lang="en">
   <head>
      ...
      <![endif]-->
      <!-- Bootstrap Core CSS -->
      <link href="{{ asset('theme/theme6/css/bootstrap.css') }}" rel="stylesheet" type="text/css">
      <!-- Icon fonts -->
      <link href="{{ asset('theme/theme6/fonts/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
      <link href="{{ asset('theme/theme6/fonts/glyphicons/bootstrap-glyphicons.css') }}" rel="stylesheet" type="text/css">
      <!-- Google fonts -->
      <link href="{{ url('https://fonts.googleapis.com/css?family=Lora:400,700i%7CMontserrat:400,700%7CPlayfair+Display:400,700,700i') }}" rel="stylesheet" type="text/css">
      <!-- Style CSS -->
      <link href="{{ asset('theme/theme6/css/style.css') }}" rel="stylesheet">
      <!-- Plugins CSS -->
      <link rel="{{ asset('theme/theme6/stylesheet" href="css/plugins.css') }}">
      <!-- Color Style CSS -->
      <link href="{{ asset('theme/theme6/styles/lavender.css') }}" rel="stylesheet">
      <!-- Favicons-->
      <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('theme/theme6/apple-icon-72x72.png') }}">
      <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('theme/theme6/apple-icon-114x114.png') }}">
   ...
   @yield('content')
      ...
      <section id="intro" class="container-fluid">
         ...
         <div class="photowall">
            <div class="col-md-4 margin1">
               <img src="{{ url('https://images.unsplash.com/photo-1444920275954-9dddec6b714e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80')}}" alt="" class="rotate1 img-photo img-responsive">
            </div>
            <!-- /col-md-4 -->
            <div class="col-md-4  col-md-offset-4">
               <img src="{{ url('https://images.unsplash.com/photo-1492667154321-99c184cc8b89?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1287&q=80')}}" alt="" class="rotate2 img-photo img-responsive">
            </div>
            <!-- /col-md-4 -->
         </div>
         <!-- Main Picture -->
         <div class="main-picture col-md-6 col-centered"
            ...
            <!-- image-->
            <img src="{{ url('https://images.unsplash.com/photo-1529634806980-85c3dd6d34ac?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1169&q=80')}}" alt="" class="img-photo img-responsive">
         </div>
         <!--/main picture-->
               ...
               <div class="col-md-12 gallery margin1">
                  <div id="lightbox">
                     ...
                     <div class="wedding col-lg-4 col-sm-6 col-md-6">
                        <div class="isotope-item">
                           <div class="gallery-thumb">
                              <img class="img-responsive" src="{{ asset('theme/theme6/img/gallery1.jpg')}}" alt="">
                     ...
                     <div class="our-photos col-lg-4 col-sm-6 col-md-6">
                        <div class="isotope-item">
                           <div class="gallery-thumb">
                              <img class="img-responsive" src="{{ asset('theme/theme6/img/gallery2.jpg')}}" alt="">
                     ...
                     <div class="wedding col-lg-4 col-sm-6 col-md-6">
                        <div class="isotope-item">
                           <div class="gallery-thumb">
                              <img class="img-responsive" src="{{ asset('theme/theme6/img/gallery3.jpg')}}" alt="">
                     ...
                     <div class="wedding col-lg-4 col-sm-6 col-md-6">
                        <div class="isotope-item">
                           <div class="gallery-thumb">
                              <img class="img-responsive" src="{{ asset('theme/theme6/img/gallery4.jpg')}}" alt="">
                     ...
                     <div class="wedding col-lg-4 col-sm-6 col-md-6">
                        <div class="isotope-item">
                           <div class="gallery-thumb">
                              <img class="img-responsive" src="{{ asset('theme/theme6/img/gallery5.jpg')}}" alt="">
                     ...
                     <div class="our-photos col-lg-4 col-sm-6 col-md-6">
                        <div class="isotope-item">
                           <div class="gallery-thumb">
                              <img class="img-responsive" src="{{ asset('theme/theme6/img/gallery6.jpg')}}" alt="">
                     ...
                     <div class="our-photos col-lg-4 col-sm-6 col-md-6">
                        <div class="isotope-item">
                           <div class="gallery-thumb">
                              <img class="img-responsive" src="{{ asset('theme/theme6/img/gallery7.jpg')}}" alt="">
      ...
      <script src="{{ asset('theme/theme6/js/jquery.min.js') }}"></script>
      <script src="{{ asset('theme/theme6/js/bootstrap.min.js') }}"></script>
      <!-- Main Js -->
      <script src="{{ asset('theme/theme6/js/main.js') }}"></script>
      <!-- RSVP form -->
      <script src="{{ asset('theme/theme6/js/rsvp.js') }}"></script>
      <!--Other Plugins -->
      <script src="{{ asset('theme/theme6/js/plugins.js') }}"></script>
      <!-- Prefix free CSS -->
      <script src="{{ asset('theme/theme6/js/prefixfree.js') }}"></script>
      <!-- Open Street maps-->
      <script src="{{ asset('theme/theme6/js/map.js') }}"></script>	
   </body>
</html>