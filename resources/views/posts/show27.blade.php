...
<html lang="en-US">
	...
	@yield('content')
		...
		<div id="wrap-content" class="page-content custom-page-template">
			...
			<!-- /SECTION 3 -->
			<!-- SECTION 4 -->
			<div id="home-section-6-4" class="section-holder home-section-6-4 parallax parallax05" style="background-image:url({{ asset('theme/theme13/images/pages/contact-page.jpg')}});">
				<div class="container">
					<div class="row">
