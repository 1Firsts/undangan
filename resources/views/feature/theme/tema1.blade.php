...
@section('content')
                <div class="row">
                  <div class="col">
                      <div class="card">
                          <div class="card-body">
                              <h5 class="card-title">Buat Tema 1</h5>
                              <p class="card-description">Form Pembuatan Tema Kategori 1</p>
                              
                              <form action="{{ route('buat_tema', 1) }}" enctype="multipart/form-data" method="POST">
                                @csrf
