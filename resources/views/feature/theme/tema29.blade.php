...
@section('content')
                <div class="row">
                  <div class="col">
                      <div class="card">
                          <div class="card-body">
                              <h5 class="card-title">Buat Tema 29</h5>
                              <p class="card-description">Form Pembuatan Tema Kategori 29</p>
                              
                              <form action="{{ route('buat_tema', 29) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                  ...
                                  <div class="row mb-3">
                                    <label for="foto_galeri9" class="col-sm-2 col-form-label">Foto Galeri 9</label>
                                    <div class="col-sm-10">
                                      <input class="form-control @error('foto_galeri9') is-invalid @enderror" type="file" name="foto_galeri9" id="foto_galeri9" value="{{ old('foto_galeri9') }}">
                                    </div>
                                    @error('foto_galeri9')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                  ...
                                  <div class="row mb-3">
                                    <label for="foto_galeri10" class="col-sm-2 col-form-label">Foto Galeri 10</label>
                                    <div class="col-sm-10">
                                      <input class="form-control @error('foto_galeri10') is-invalid @enderror" type="file" name="foto_galeri10" id="foto_galeri10" value="{{ old('foto_galeri10') }}">
                                    </div>
                                    @error('foto_galeri10')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                  ...
                                  <input type="hidden" name="tema_category" id="tema_category" value="Tema 29">
