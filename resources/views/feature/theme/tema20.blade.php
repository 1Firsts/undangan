...
@section('content')
                <div class="row">
                  <div class="col">
                      <div class="card">
                          <div class="card-body">
                              <h5 class="card-title">Buat Tema 20</h5>
                              <p class="card-description">Form Pembuatan Tema Kategori 20</p>
                              ...
                              <form action="{{ route('buat_tema', 20) }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="row mb-3">
                                  ...
                                  <input type="hidden" name="tema_category" id="tema_category" value="Tema 20">
