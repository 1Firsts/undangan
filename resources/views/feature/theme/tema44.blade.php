...
@section('content')
                <div class="row">
                  <div class="col">
                      <div class="card">
                          <div class="card-body">
                              <h5 class="card-title">Buat Tema 44</h5>
                              <p class="card-description">Form Pembuatan Tema Kategori 44</p>
                              
                              <form action="{{ route('buat_tema', 44) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                 ...
                                 <label for="nama_panggilan" class="col-sm-2 col-form-label text-info">Foto Gallery</label>
                                  ...
                                  <input type="hidden" name="tema_category" id="tema_category" value="Tema 44">
