      ...
      <section id="intro" class="container-fluid">
         ...
         <div class="photowall">
            <div class="col-md-4 margin1">
               <img src="{{ asset('theme/theme6/img/couple1.jpg')}}" alt="" class="rotate1 img-photo img-responsive">
            </div>
            <!-- /col-md-4 -->
            <div class="col-md-4  col-md-offset-4">
               <img src="{{ asset('theme/theme6/img/couple2.jpg')}}" alt="" class="rotate2 img-photo img-responsive">
            </div>
            <!-- /col-md-4 -->
         </div>
         <!-- Main Picture -->
         <div class="main-picture col-md-6 col-centered"
            ...
            <!-- image-->
            <img src="{{ asset('theme/theme6/img/couplemain.jpg')}}" alt="" class="img-photo img-responsive">
         </div>
         <!--/main picture-->
