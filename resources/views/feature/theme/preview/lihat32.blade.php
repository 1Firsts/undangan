            ...
            <div class="container">        	
                <div id="wedding">
                    <hgroup>
                        ...
                        <h6>on</h6>
                        <h3>Saturday 23 Feb , 2013</h3>
                        <h6>@</h6>
                        <h3>Caliber Hotel in New York City</h3>
                    </hgroup>
                    <span class="invite">With the will of heaven and earth you are all invited</span>
                    ...
                    <div class="one-half column last">
                        <div class="contact-details">
                            <aside id="address">
                                <h3>Address</h3>
                                <ul>
                                    <li> <address class="address">500 Linden Street <br> Fort Collins, CO 80524 </address></li>
                                    <li> <address class="iphone"> 0455 - 022 - 3554 <br> 1556 - 144 - 4546 </address></li>
                                    <li> <a href="#" class="mail">spalush@gmail.com </a></li>
                                </ul>
                            </aside>
                            <aside class="place">
                                <h3>From 1-f North to Downstreet</h3>
                                <ul>
                                    <li>Nullam scelerisque ornare quam, id varius tellus vehicula vel.</li>
                                    <li>Cras quis urna eget elit consectetur fringilla.</li>
                                    <li>Pellentesque nec ante augue, id consequat turpis.</li>
                                </ul>
                            </aside>
                            <aside>
                                <h3>Parking</h3>
                ...
                <div class="container">
                    <nav>
                        <ul class="category-filter">
                            <li><a href="#" class="active"  data-filter="*"> All (58) </a></li>
                            <li><a href="#" data-filter=".pre-marriage">Pre-marriage (32)</a></li>
                            <li><a href="#" data-filter=".reception">Reception (43)</a></li>
                            <li><a href="#" data-filter=".bachelor">Bachelor Party (18)</a></li>
                            <li><a href="#" data-filter=".bridal">Bridal Shower (12)</a></li>
                            <li><a href="#" data-filter=".location">Location (10)</a></li>
                        </ul>
                    </nav>
        ...
        <footer>
            <div class="container">
                <div class="aligncenter-text copyright">
                    ...
                    <p>Catherene &amp; William 23 Feb 2013. Site design by Design Themes</p>
                </div>
            </div>
        </footer>
