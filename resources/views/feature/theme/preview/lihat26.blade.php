...
<html lang="en-US">
	...
	<body class="home home-5">
						...
						<div class="portfolio-slider gallery-slider-holder">
							<div class="swiper-wrapper">
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-1-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div>
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-2-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div>
									<div class="item-text-holder">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-3-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-3-cols.html"> </a></div>
									<div class="item-text-holder">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-4-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-4-cols.html"> </a></div>
									<div class="item-text-holder">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-5-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div>
									<div class="item-text-holder">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-6-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-justify.html"> </a></div>
									<div class="item-text-holder">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-7-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-5-cols.html"> </a></div>
									<div class="item-text-holder">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-8-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-2-cols.html"> </a></div>
									<div class="item-text-holder">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-9-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div>
									<div class="item-text-holder">
								...
								<!-- /item-slider -->
								<div class="swiper-slide item-slider">
									<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-10-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div>
									<div class="item-text-holder">
		...
		<div id="wrap-content" class="page-content custom-page-template">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6 order1 margin-bm50">
							<div class="margin-l50">
								<img class="img-fluid radius10" src="{{ asset('theme/theme13/images/home/home2-img4.jpg')}}" alt=" " />
							</div>
						</div>
						<!-- /col-lg-6 -->
					</div>
					...
					<div class="row align-items-center">
						<div class="col-lg-6 margin-bm50">
							<div class="margin-r50">
								<img class="img-fluid radius10" src="{{ asset('theme/theme13/images/home/home2-img2.jpg')}}" alt=" " />
							</div>
						</div>
						<!-- /col-lg-6 -->
						<div class="col-lg-6">
			...
			<!-- /SECTION 4 -->
			<!-- SECTION 5 -->
			<div id="home-section-5-5" class="section-holder home-section-5-5 parallax" style="background-image:url({{ asset('theme/theme13/images/pages/contact-page.jpg')}});">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
