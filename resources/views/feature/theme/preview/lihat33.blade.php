...
<html lang="en" class="no-js">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('theme/theme15/favicon.ico') }}">

    <link rel="stylesheet" href="{{ asset('theme/theme15/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/theme15/css/normalize.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/theme15/css/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/theme15/css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/theme15/css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/theme15/css/main.css') }}" type="text/css">

    <script src="{{ asset('theme/theme15/js/jquery-1.12.4.min.js') }}"></script>
    <script src="{{ asset('theme/theme15/js/modernizr.custom.js') }}"></script>
  </head>
  ...
  @yield('content')
    ...
    <div id="main-container">
      ...
      <div class="sections">
        ...
        <section id="home" class="home-section clearfix">
          <div id="hs-image-block" class="hs-image-block" style="background-image: url({{ asset('theme/theme15/images/main_photo_1.jpg')}}); background-attachment: fixed; background-position: 50% 0;" data-stellar-background-ratio="0.3">
            ...
            <div class="about-us clearfix"> 
              <div class="about-us-block first-block">
                <div class="top-block">
                  ...
                  <div class="photo">
                    <img src="{{ asset('theme/theme15/images/photo_1.jpg')}}" alt="">
                  </div>
                </div>
              ...
              <div class="heart">
                <img src="{{ asset('theme/theme15/images/heart_img.png')}}" alt="">
              </div>
              ...
              <div class="about-us-block second-block">
                <div class="top-block">
                  ...
                  <div class="photo">
                    <img src="{{ asset('theme/theme15/images/photo_2.jpg')}}" alt="">
                  </div>
                </div>
                <div class="bottom-block">
                  <p>Nulla eros eros, tincidunt in tempor vitae, pellentesque non mi. Mauris eu molestie lacus, eget dictum orci. Etiam semper mauris neque, in posuere lacus varius.</p>
          ...
          <div class="container">
            ...
            <div class="row story-row">
              <div class="col-sm-12 col-md-5 story-block text-center">
                <div class="story-image scale-image-effect">
                  <img src="{{ asset('theme/theme15/images/story_photo_1.jpg')}}" alt="">
                </div>
              </div>
            ...
            <div class="row story-row">
              <div class="col-sm-12 col-md-5 col-md-push-7 story-block text-center">
                <div class="story-image scale-image-effect">
                  <img src="{{ asset('theme/theme15/images/story_photo_2.jpg')}}" alt="">
                </div>
              </div>
              <div class="col-sm-12 col-md-2 story-block text-center">
                <div class="story-date">
            ...
            <div class="row story-row">
              <div class="col-sm-12 col-md-5 story-block text-center">
                <div class="story-image scale-image-effect">
                  <img src="{{ asset('theme/theme15/images/story_photo_3.jpg')}}" alt="">
                </div>
              </div>
              <div class="col-sm-12 col-md-2 story-block text-center">
                <div class="story-date">
            ...
            <div class="row">
              ...
              <div class="col-md-6 event-block">
                <div class="event-photo scale-image-effect">
                  <img src="{{ asset('theme/theme15/images/photo_the_ceremony.jpg')}}" alt="">
                </div>
              ...
              <div class="col-md-6 event-block">
                <div class="event-photo scale-image-effect">
                  <img src="{{ asset('theme/theme15/images/photo_the_party.jpg')}}" alt="">
                </div>
          ...
          <div class="container">
            ...
            <div class="row gallery-grid">
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_1.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_1.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_2.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_2.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_3.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_3.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_4.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_4.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_5.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_5.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_6.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_6.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_7.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_7.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_8.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_8.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme15/images/gallery/gallery_photo_9.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme15/images/gallery/gallery_photo_9.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
            </div>
        ...
        <footer id="thanks" class="footer">
          <div id="footer-image-block" class="footer-image-block" style="background-image: url({{ asset('theme/theme15/images/footer_photo.jpg')}}); background-attachment: fixed; background-position: 50%;" data-stellar-background-ratio="0.3">
    ...
    <script src="{{ asset('theme/theme15/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('theme/theme15/js/jquery.stellar.min.js') }}"></script>
    <script src="{{ asset('theme/theme15/js/validator.js') }}"></script>
    <script src="{{ asset('theme/theme15/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('theme/theme15/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('theme/theme15/js/jquery.countdown.js') }}"></script>
    <script src="{{ asset('theme/theme15/js/jquery.malihu.PageScroll2id.min.js') }}"></script>
    <script src="{{ asset('theme/theme15/js/main.js') }}"></script>
  </body>
</html>
