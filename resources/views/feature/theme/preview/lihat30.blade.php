							...
							<div id="portfolio-2cols-bigspace" class="portfolio-grid-container">
								<div class="portfolio-grid">
									<div class="item-portfolio item-2cols wedding">
										<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-1-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a class="cursor-eye" href="gallery-grid-3-cols.html"> </a></div>
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-2cols wedding">
										<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-2-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a class="cursor-eye" href="gallery-grid-2-cols.html"> </a></div>
										<div class="item-text-holder">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-2cols wedding">
										<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-3-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a class="cursor-eye" href="gallery-grid-4-cols.html"> </a></div>
										<div class="item-text-holder">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-2cols wedding">
										<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-4-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a class="cursor-eye" href="gallery-grid-3-cols.html"> </a></div>
										<div class="item-text-holder">
									...
									<div class="item-portfolio item-2cols lifestyle wedding">
										<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-5-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a class="cursor-eye" href="gallery-grid-5-cols.html"> </a></div>
										<div class="item-text-holder">
									...
									<!-- /item-portfolio -->
									<div class="item-portfolio item-2cols lifestyle wedding">
										<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-6-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a class="cursor-eye" href="gallery-grid-3-cols.html"> </a></div>
										<div class="item-text-holder">
									...
									<div class="item-portfolio item-2cols portrait">
										<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-7-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a class="cursor-eye" href="gallery-grid-4-cols.html"> </a></div>
										<div class="item-text-holder">
									...
									<div class="item-portfolio item-2cols lifestyle">
										<div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-8-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a class="cursor-eye" href="gallery-grid-4-cols.html"> </a></div>
										<div class="item-text-holder">
