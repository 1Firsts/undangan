            ...
            <div class="container">
               ...
               <div class="row min-vh-80 align-items-center z-index-2 position-relative text-center">
                  <div class="col-12">
                     ...
                     <p class="font-weight-300 text-light  lead mb-5 ">Saturday May 30th, 2019 - 28 Chalmers Street, Sydney. </p>
                     ...
                     <div class="mb-3 pb-3 px-4">
                        <div class="svg-mask-container">
                           <svg width="100%" height="100%" version="1.1" xmlns="{{ url('http://www.w3.org/2000/svg')}}" xmlns:xlink="{{ url('http://www.w3.org/1999/xlink')}}" x="0px" y="0px" viewBox="0 0 607 532" enable-background="new 0 0 607 532" xml:space="preserve">
                              ...
                              <image mask="url(#mask-small-1)" width="607" height="532" xlink:href="{{ asset('theme/theme4/assets/img/mask-md.jpg')}}" />
                           </svg>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-4 d-flex flex-column align-items-center">
                     <div class="px-5 mb-4 pb-4 ">
                        ...
                        <svg  width="100%" height="100%" version="1.1" xmlns="{{ url('http://www.w3.org/2000/svg')}}" xmlns:xlink="{{ url('http://www.w3.org/1999/xlink')}}" x="0px" y="0px" viewBox="0 0 607 532" enable-background="new 0 0 607 532" xml:space="preserve">
                           ...
                           <image mask="url(#mask-middle-1)" width="607" height="532" xlink:href="{{ asset('theme/theme4/assets/img/mask-md.jpg')}}"></image>
                        </svg>
                     </div>
                        <div class=" mt-4">
                  ...
                  <div class="col-md-4 d-flex flex-column align-items-center">
                     <div class=" px-5 mb-4 pb-4 ">
                        ...
                        <svg width="100%" height="100%" version="1.1" xmlns="{{ url('http://www.w3.org/2000/svg')}}" xmlns:xlink="{{ url('http://www.w3.org/1999/xlink')}}" x="0px" y="0px" viewBox="0 0 607 532" enable-background="new 0 0 607 532" xml:space="preserve">
                           ...
                           <image mask="url(#mask-middle-2)" width="607" height="532" xlink:href="{{ asset('theme/theme4/assets/img/mask-md.jpg')}}"></image>
                        </svg>
                     </div>
                        <div class=" mt-4">
               ...
               <div class="col-lg-11 mx-lg-auto">
                  <div class="row justify-content-center card-gutters">
                     <div class="col-7 mb-3">
                        <a href="{{ asset('theme/theme4/assets/img/offset/large/1.jpg')}}" class="popup-image hover-effect d-block">
                           <img class="img-fluid" src="{{ asset('theme/theme4/assets/img/offset/1.jpg')}}" alt="">
                     ...
                     <div class="col-5 align-self-end mb-3">
                        <a href="{{ asset('theme/theme4/assets/img/offset/large/2.jpg')}}" class="popup-image hover-effect d-block">
                           <img class="img-fluid" src="{{ asset('theme/theme4/assets/img/offset/2.jpg')}}" alt="">
                           <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1"  xmlns="{{ url('http://www.w3.org/2000/svg')}}" xmlns:xlink="{{ url('http://www.w3.org/1999/xlink')}}" x="0px" y="0px"
                                    viewBox="0 0 73.6404 64.5606" enable-background="new 0 0 73.6404 64.5606" xml:space="preserve">
                     ...
                     <div class="col-5">
                        <a href="{{ asset('theme/theme4/assets/img/offset/large/3.jpg')}}" class="popup-image hover-effect d-block">
                           <img class="img-fluid" src="{{ asset('theme/theme4/assets/img/offset/3.jpg')}}" alt="">
                           <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1" xmlns="{{ url('http://www.w3.org/2000/svg')}}" xmlns:xlink="{{ url('http://www.w3.org/1999/xlink')}}" x="0px" y="0px"
                                    viewBox="0 0 73.6404 64.5606" enable-background="new 0 0 73.6404 64.5606" xml:space="preserve">
                     ...
                     <div class="col-3">
                        <a href="{{ asset('theme/theme4/assets/img/offset/large/4.jpg ')}}" class="popup-image hover-effect d-block">
                           <img class="img-fluid" src="{{ asset('theme/theme4/assets/img/offset/4.jpg')}}" alt="">
                           <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1"  xmlns="{{ url('http://www.w3.org/2000/svg')}}" xmlns:xlink="{{ url('http://www.w3.org/1999/xlink')}}" x="0px" y="0px"
                                    viewBox="0 0 73.6404 64.5606" enable-background="new 0 0 73.6404 64.5606" xml:space="preserve">
                     ...
                     <div class="col-3">
                        <a href="{{ asset('theme/theme4/assets/img/offset/large/5.jpg')}}" class="popup-image hover-effect d-block">
                           <img class="img-fluid" src="{{ asset('theme/theme4/assets/img/offset/5.jpg')}}" alt="">
                           <span class="hover-effect-container">
                              <span class="hover-effect-icon has-svg">
                                 <svg version="1.1" xmlns="{{ url('http://www.w3.org/2000/svg')}}" xmlns:xlink="{{ url('http://www.w3.org/1999/xlink')}}" x="0px" y="0px"
                                    viewBox="0 0 73.6404 64.5606" enable-background="new 0 0 73.6404 64.5606" xml:space="preserve">
