...
<html lang="en-US">
	...
	<body class="home">
		...
		<div id="wrap-content" class="page-content custom-page-template">
			...
			<!-- SECTION 2 -->
			<div id="home-section-8-2" class="section-holder home-section-8-2 parallax" style="background-image:url({{ asset('theme/theme13/images/pages/contact-page.jpg')}});">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
					...
					<div class="row">
						...
						<div class="col-lg-7">
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-1-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Tracy &amp; Aaron</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-2-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-3-cols.html">Paul &amp; Jane</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-3-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-3-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-masonry-3-cols.html">Angela &amp; Zach</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-4-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-4-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-masonry-4-cols.html">Diana &amp; Max</a></h2><ul class="portfolio-categ"><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-5-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Tina &amp; Robi</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-6-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-justify.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-justify.html">Clara &amp; Andrew</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li><li><a href="#">Wedding</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-7-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-5-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-masonry-5-cols.html">Street People</a></h2><ul class="portfolio-categ"><li><a href="#">Portrait</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-8-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-masonry-2-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-masonry-2-cols.html">Ballet Dancers</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-9-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-3-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-3-cols.html">Black & White</a></h2><ul class="portfolio-categ"><li><a href="#">Lifestyle</a></li><li><a href="#">Portrait</a></li></ul></div>
								</div>
								<!-- /item-slider -->
								<div class="swiper-slide item-slider"><div class="post-image item-grid-image"><img loading="lazy" src="{{ asset('theme/theme13/images/portfolio/featured-images/gal-10-grid.jpg')}}" class="img-fluid" alt=" " width="750" height="750"> <a href="gallery-grid-4-cols.html"> </a></div><div class="item-text-holder"><h2 class="article-title display-6"><a href="gallery-grid-4-cols.html">Studio Photos</a></h2><ul class="portfolio-categ"><li><a href="#">Portrait</a></li></ul></div>
								</div>
								<!-- /item-slider -->
							</div>
							<!-- /swiper-wrapper -->
							<div class="swiper-mt-button-prev portfolio-slider-btn-prev">
								<svg version="1.1" xmlns="{{ url('http://www.w3.org/2000/svg')}}" xmlns:xlink="{{ url('http://www.w3.org/1999/xlink')}}" x="0px" y="0px" viewBox="0 0 55 55" style="enable-background:new 0 0 55 55;" xml:space="preserve">
									<path d="M33.2,28.3l-8.8,8.8c-0.4,0.4-1.1,0.4-1.5,0l-1-1c-0.4-0.4-0.4-1.1,0-1.5l7-7l-7-7c-0.4-0.4-0.4-1.1,0-1.5l1-1
										c0.4-0.4,1.1-0.4,1.5,0l8.8,8.8C33.6,27.2,33.6,27.8,33.2,28.3z"></path>
									<path d="M27.5,55C12.3,55,0,42.7,0,27.5S12.3,0,27.5,0S55,12.3,55,27.5S42.7,55,27.5,55z M27.5,5C15.1,5,5,15.1,5,27.5
										S15.1,50,27.5,50S50,39.9,50,27.5S39.9,5,27.5,5z"></path>
		...
		<!-- CONTACT FORM JS -->
		<script src="{{ asset('theme/theme13/js/jquery.form.min.js') }}"></script>
		<script src="{{ asset('theme/theme13/js/contactform.js') }}"></script>
	</body>
</html>