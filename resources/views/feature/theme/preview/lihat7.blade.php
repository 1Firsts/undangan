...
<html lang="en">
   <head>
      ...
      <!-- Google fonts -->
      <link href="{{ asset('https://fonts.googleapis.com/css?family=Lora:400,700i%7CMontserrat:400,700%7CPlayfair+Display:400,700,700i') }}" rel="stylesheet" type="text/css">
      <!-- Style CSS -->
      <link href="{{ asset('theme/theme6/css/style.css') }}" rel="stylesheet">
      <!-- Plugins CSS -->
      <link rel="stylesheet" href="{{ asset('theme/theme6/css/plugins.css') }}">
      <!-- Color Style CSS -->
   ...
   <body id="page-top" data-spy="scroll" data-target=".navbar-custom">   
      ...
      <section id="intro" class="container-fluid">
         <div class="intro-heading margin col-md-12 text-center">
            <h1 class="text-light">Maria <span class="italic text-light"> & </span> Jonas
            </h1>
      ...
      <section id="about" class="watercolor">
         ...
         <div class="container">
            ...
            <div class="col-md-5 col-md-offset-1">
               <img src="{{ asset('theme/theme6/img/bride.jpg')}}" alt="" class="main-img img-responsive img-circle"/>
            ...
            <div class="col-md-5 res-margin">
               <img src="{{ asset('theme/theme6/img/groom.jpg')}}" alt="" class="main-img img-responsive img-circle"/>
