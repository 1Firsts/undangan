...
<head>
    ...
    <link href="{{ asset('theme/theme9/assets/css/main.css') }}" rel="stylesheet" type="text/css" />
    <link rel="shortcut icon" type="image/png" href="{{ asset('theme/theme9/assets/images/favicon.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('theme/theme9/assets/images/favicon.png') }}" />
</head>
...
<body>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                                            <div class="wd_img_round">
                                                ...
                                                <div class="overlay">
                                                    <span><a href="assets/images/our_story/01.jpg" class="fancybox"><i class="fa fa-search"></i></a></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 col-md-12 col-lg-push-8 col-md-push-8 col-sm-12 col-12">
                                            <div class="wd_img_round">
                                                <img src="http://placehold.it/370x370" alt="" />
                                                <div class="overlay">
                                                    <span><a href="assets/images/our_story/02.jpg" class="fancybox"><i class="fa fa-search"></i></a></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                                            <div class="wd_img_round">
                                                <img src="http://placehold.it/370x370" alt="" />
                                                <div class="overlay">
                                                    <span><a href="assets/images/our_story/03.jpg" class="fancybox"><i class="fa fa-search"></i></a></span>
                                                </div>
                                            </div>
                                            <div class="wd_post_date wd_right">
                                                <span class="number"> 26 Jan</span>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-4 col-md-12 col-lg-push-8 col-md-push-8 col-sm-12 col-12">
                                            <div class="wd_img_round">
                                                <img src="http://placehold.it/370x370" alt="" />
                                                <div class="overlay">
                                                    <span><a href="assets/images/our_story/04.jpg" class="fancybox"><i class="fa fa-search"></i></a></span>
                                                </div>
                                            </div>
                                            <div class="wd_post_date wd_left">
                                                <span class="number"> 26 Jan</span>
                                    ...
                                    <div id="owl_man_family" class="owl-carousel owl-theme">
                                        <div class="item">
                                            <div class="wd_family_member">
                                                <img class="img-responsive" src="http://placehold.it/134x134" alt="" />
                                                <h3>Bill Swan</h3>
                                                <h4>Father</h4>
                                            </div>
                                        </div>
                                                ...
                                                <div class="wd_event_info_back">
                                                    ...
                                                    <div class="info_box_last">
                                                        <div class="map_fancybox">
                                                            <div id="mapBox2">
                                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3445.911215166146!2d-97.74762068496076!3d30.26811081492685!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8644b50916d8f039%3A0x951d29b2e5bb77da!2s522+Lavaca+St%2C+Austin%2C+TX+78701%2C+USA!5e0!3m2!1sen!2s!4v1455343431264"
                                                                    width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe><br /><small><a href="https://www.google.com/maps?ll=30.268106,-97.745432&z=16&t=m&hl=en-GB&gl=US&mapclient=embed&q=522+Lavaca+St+Austin,+TX+78701+USA" target="_blank" >View Larger Map</a></small>
                                                            </div>
                                                        </div>
                    ...
                    <div class="wd_gallery_section">
                        <div class="row m-0 justify-content-center">
                            <div class="col-lg-4 col-md-4">
                                <div class="row mb-3">
                                    <div class="wd_gal_img">
                                        <img src="http://placehold.it/450x299" alt="" class="img-responsive" />
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="row mb-3">
                                    <div class="wd_gal_img">
                                        <img src="http://placehold.it/450x596" alt="" class="img-responsive" />
                                        <div class="wd_gal_overlay">
                                            <div class="wd_gal_center">
                                                <h4>Lorem ipsum dolor sit amet</h4>
                                                <ul class="wd_social_icons">
    ...
    <script src="assets/js/animation-bubble.js"></script>
    <script type="text/javascript" src="assets/js/plugins/flipclock/flipclock.js"></script>
    <!-- <script type="text/javascript" src="assets/js/plugins/smoothscroll/smoothscroll.js"></script> -->
    <!-- REVOLUTION JS FILES -->
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/jquery.themepunch.tools.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/jquery.themepunch.revolution.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.actions.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.carousel.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.kenburn.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.layeranimation.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.migration.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.navigation.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.parallax.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.slideanims.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/revolution/js/revolution.extension.video.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/fancybox/jquery.fancybox.js') }}"></script>
    <script type="text/javascript" src="{{ asset('theme/theme9/assets/js/plugins/countto/jquery.countTo.js') }}"></script>
    <script src="{{ asset('theme/theme9/assets/js/plugins/smoothscroll/smoothscroll.js') }}" type="text/javascript"></script>
    <script src="{{ asset('theme/theme9/assets/js/plugins/owl/owl.carousel.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('theme/theme9/assets/js/plugins/rsvp/modernizr.custom.js') }}"></script>
    <script src="{{ asset('theme/theme9/assets/js/plugins/rsvp/classie.js') }}"></script>
