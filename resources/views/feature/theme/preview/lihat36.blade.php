    ...
    <div id="main-container">
      ...
      <div class="sections">
        ...
        <section id="home" class="home-section clearfix">
          <div id="hs-image-block" class="hs-image-block" style="background-image: url({{ asset('theme/theme18/images/main_photo_1.jpg')}}); background-attachment: fixed; background-position: 50% 0;" data-stellar-background-ratio="0.3">
          ...
          <div class="container">
            ...
            <div class="row story-row">
              <div class="col-sm-12 col-md-5 story-block text-center">
                <div class="story-image scale-image-effect">
                  <img src="{{ asset('theme/theme18/images/story_photo_1.jpg')}}" alt="">
                </div>
              </div>
            ...
            <div class="row story-row">
              <div class="col-sm-12 col-md-5 col-md-push-7 story-block text-center">
                <div class="story-image scale-image-effect">
                  <img src="{{ asset('theme/theme18/images/story_photo_2.jpg')}}" alt="">
                </div>
              </div>
              <div class="col-sm-12 col-md-2 story-block text-center">
                <div class="story-date">
            ...
            <div class="row story-row">
              <div class="col-sm-12 col-md-5 story-block text-center">
                <div class="story-image scale-image-effect">
                  <img src="{{ asset('theme/theme18/images/story_photo_3.jpg')}}" alt="">
                </div>
              </div>
              <div class="col-sm-12 col-md-2 story-block text-center">
                <div class="story-date">
            ...
            <div class="row">
              ...
              <div class="col-md-6 event-block">
                <div class="event-photo scale-image-effect">
                  <img src="{{ asset('theme/theme18/images/photo_the_ceremony.jpg')}}" alt="">
                </div>
              ...
              <div class="col-md-6 event-block">
                <div class="event-photo scale-image-effect">
                  <img src="{{ asset('theme/theme18/images/photo_the_party.jpg')}}" alt="">
                </div>
          ...
          <div class="container">
            ...
            <div class="row gallery-grid">
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_1.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_1.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_2.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_2.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_3.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_3.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_4.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_4.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_5.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_5.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_6.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_6.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_7.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_7.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_8.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_8.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
              <div class="col-sm-6 col-md-4 gallery-item">
                <a href="{{ asset('theme/theme18/images/gallery/gallery_photo_9.jpg')}}" title="The Cleaner">
                  <img src="{{ asset('theme/theme18/images/gallery/gallery_photo_9.jpg')}}" alt="">
                  <div class="mask"></div>
                </a>
              </div>
            </div>
        ...
        <footer id="thanks" class="footer">
          <div id="footer-image-block" class="footer-image-block" style="background-image: url({{ asset('theme/theme18/images/footer_photo.jpg')}}); background-attachment: fixed; background-position: 50%;" data-stellar-background-ratio="0.3">
