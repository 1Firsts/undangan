...
@section('content')
                <div class="row">
                  <div class="col">
                      <div class="card">
                          <div class="card-body">
                              <h5 class="card-title">Buat Tema 26</h5>
                              <p class="card-description">Form Pembuatan Tema Kategori 26</p>
                              
                              <form action="{{ route('buat_tema', 26) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row mb-3">
                                  ...
                                  <input type="hidden" name="tema_category" id="tema_category" value="Tema 26">
