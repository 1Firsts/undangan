...
@section('content')
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Data Tema 2</h5>
                                <p>Data dari Kategori Tema 2.</p>
                                <table id="zero-conf" class="display" style="width:100%">
                                    ...
                                    @foreach ($seeorders2 as $seeorder)
                                        <tr>
                                            ...
                                            <td>2012/04/25</td>
                                            <td>
                                                <form action="{{ route('seeorder2.delete', ['id' => $seeorder->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
