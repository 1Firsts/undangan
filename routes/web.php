...
Route::view('/vcoba', 'vcoba');
Route::view('/welcome', 'welcome');
Route::view('/feature/create', 'feature/create');
Route::view('/feature/lockscreen', 'feature/lockscreen');
Route::view('/feature/login', 'feature/login');
Route::view('/feature/order', 'feature/order');
Route::view('/feature/register', 'feature/register');
